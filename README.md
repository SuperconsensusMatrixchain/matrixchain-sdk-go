...
[![GoDoc](https://pkg.go.dev/badge/github.com/xuperchain/xuper-sdk-go?utm_source=godoc)](https://pkg.go.dev/github.com/SuperconsensusMatrixchain/matrixchain-sdk-go/v2)
...
```bash
go get github.com/SuperconsensusMatrixchain/matrixchain-sdk-go/v2
```
